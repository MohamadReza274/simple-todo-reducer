...
import {TodoAction} from "../Reducers/useTodoReducer.ts";
...
const AddTodo = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>, dispatch: React.Dispatch<TodoAction>) => {
        e.preventDefault();
    ...
    return (
        <TodoContext.Consumer>
            {({dispatch}) => {
                return <form className={"p-4 max-w-md"} onSubmit={(e) => handleSubmit(e, dispatch)}>
